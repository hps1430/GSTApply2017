...
/**
 * Created by harsh singh on 23-06-2017.
 */

public class GetProvisionalids extends Fragment {


    View getprovisionalview;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        getprovisionalview = inflater.inflate(R.layout.fragment_getprovisionalids,container,false);





        AdView adview = (AdView) getprovisionalview.findViewById(R.id.adView_getprovisionalids);
        AdRequest adrequest = new AdRequest.Builder().build();
        adview.loadAd(adrequest);


        mWebView = (WebView) getprovisionalview.findViewById(R.id.webView_getprovisionalids);
        ...
        else
        {
            ...
            mWebView.loadUrl("https://www.aces.gov.in/STASE/ui/jsp/common/loginpage.do");
