...
public class WhyRegister extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        whyregisterveiw = inflater.inflate(R.layout.fragment_whyregister,container,false);


        AdView adview = (AdView) whyregisterveiw.findViewById(R.id.adView_whyregister);
        AdRequest adrequest = new AdRequest.Builder().build();
        adview.loadAd(adrequest);


        mWebView = (WebView) whyregisterveiw.findViewById(R.id.webView_whyregister);
        ...
        {
            mWebView.loadUrl("https://cleartax.in/s/gst-registration/");
